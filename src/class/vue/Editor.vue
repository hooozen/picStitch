<template>
  <div class="modal-main stitch-modal">
    ...
    <div class="modal__body">
      <canvas id="stitchCanvas" width="600" ref="canvasEl" @mousedown="mouseDownHandler" @mouseleave="mouseDown = false"
        @mouseup="mouseDown = false" @mousemove="mouseMoveHandler"></canvas>
    </div>
